...
- **Run-history sync (Pro-real Part B)** — `history_list` (local mirror), `history_sync_pull` (cloud → mirror, Pro-gated), `history_sync_push_all` (one-shot backfill)
