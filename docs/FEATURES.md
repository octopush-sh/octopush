...
- **Shared micro-track primitive (unconsumed foundation)** — `direct/StageDots.tsx` is a universal stage-dot track built for future run-track surfaces; no canvas wires it in yet.
