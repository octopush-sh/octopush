    ...
    <div className="flex min-h-0 flex-1 flex-col octo-fade-in">
      <div className="px-8 pt-6 pb-3">
        ...
        <input
          ...
          className="mb-1 w-full border-b border-transparent bg-transparent pb-1 font-serif text-[22px] tracking-[-0.005em] text-octo-ivory outline-none transition-colors duration-[180ms] placeholder:font-serif placeholder:text-octo-mute hover:border-octo-border-strong focus:border-[var(--brass-dim)]"
        />
        <input
          value={description}
          ...
          className="w-full border-b border-transparent bg-transparent pb-1 font-mono text-xs text-octo-sage outline-none transition-colors duration-[180ms] placeholder:text-octo-mute hover:border-octo-border-strong focus:border-[var(--brass-dim)]"
        />
      </div>
