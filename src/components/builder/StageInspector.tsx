...
export function StageInspector({ node, ancestors, loop, issue, onPatch, onSetLoop, onClose }: Props) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      {/* Fixed header — archetype eyebrow + name + close. */}
      <div className="flex items-start justify-between border-b border-octo-hairline px-4 py-3">
        <div>
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto p-4">
        ...
        <label className="flex flex-col gap-1">
          ...
          <input
            ...
            className="w-full rounded-sm border border-octo-border-strong bg-octo-onyx px-2 py-1.5 font-serif text-[13px] text-octo-ivory outline-none transition-colors duration-[150ms] placeholder:text-octo-mute focus:border-[var(--brass-dim)]"
          />
        </label>
        ...
        {/* Engine group: model, reasoning, escalation. */}
        <div className="flex flex-col gap-4 border-t border-octo-hairline pt-4">
          {/* Model */}
        ...
        {/* Execution group: substrate, approval, tools, max turns. */}
        <div className="flex flex-col gap-4 border-t border-octo-hairline pt-4">
          {/* Substrate + gate */}
        ...
        <div className="flex flex-col gap-4 border-t border-octo-hairline pt-4">
          <label className="flex flex-col gap-1">
            ...
            <textarea
              ...
              rows={3}
              className="w-full resize-y rounded-sm border border-octo-border-strong bg-octo-onyx px-2 py-1.5 font-mono text-[11px] leading-relaxed text-octo-ivory outline-none transition-colors duration-[150ms] placeholder:text-octo-mute focus:border-[var(--brass-dim)]"
            />
          </label>
        </div>
